...
# from CV import ZD as TeamX
from teamZ import TeamX as TeamY
...
unity_env = UnityEnvironment(r"D:\dPickleBallEnv-main\PickleBallFinal\Pickleball_Build_Competition\dp.exe", side_channels=[string_channel, channel])
